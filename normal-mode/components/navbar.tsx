        ...
        >
          <div className="flex flex-col gap-1">
            ...
            <div className="m-link mt-2 flex justify-center">
              {/* Plain <a>, not the shared <Button> — it renders via
                  next/link for non-hash hrefs, which would prepend the
              ...
              >
                ...
                <span
                  aria-hidden
                  className="grid size-8 place-items-center rounded-full bg-bg text-fg transition-transform duration-300 group-hover:translate-x-0.5"
                >
