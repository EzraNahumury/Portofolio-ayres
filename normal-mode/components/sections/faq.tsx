...
export function FAQ() {
  ...
  // one is visible at a glance without needing to scroll the list.
  const [openIdx, setOpenIdx] = useState<number | null>(null);
  const itemRefs = useRef<(HTMLDivElement | null)[]>([]);

  // Auto-scroll the opened item into view within the list's own scroll
  // area — the visitor never has to operate a scrollbar manually.
  useEffect(() => {
